...
public class Bullets {
	...
	// 构造函数2，接受另外两个参数
	public Bullets(int x, int y, boolean good, Direction dir, TankClientMain tc) {
		this(x, y, dir);
		this.good = good;
		this.tc = tc;
	}
	...
	private void move() {
		...
		if (x < 0 || y < 0 || x > TankClientMain.Fram_width
				|| y > TankClientMain.Fram_length) {
			live = false;
		}
	}
